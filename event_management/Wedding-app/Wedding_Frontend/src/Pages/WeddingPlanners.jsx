...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5 ">
        ...
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">Rs.3,50,000</span>
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full   bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5 ">
        ...
        <br />
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">Rs.2,70,000</span>
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5 ">
        ...
        <br />
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">Rs.3,35,000</span>
