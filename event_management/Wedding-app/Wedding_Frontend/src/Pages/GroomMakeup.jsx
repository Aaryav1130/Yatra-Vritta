...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img class="p-8 rounded-t-lg h-96 max-w-96" src="https://www.wedium.com/bhubaneswar/wp-content/uploads/2022/03/groom-makeup-in-bbsr.jpg" alt="Photography image" />
    </Link>
    <div class="px-5 pb-5 ">
        <Link to="#">
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full   bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img class="p-8 rounded-t-lg h-96 max-w-96" src="https://i.pinimg.com/736x/c4/54/c7/c454c71bec68ace68d7241c83081b3b8.jpg" alt="Photography image" />
    </Link>
    <div class="px-5 pb-5 ">
        <Link to="#">
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
        <img class="p-8 rounded-t-lg h-96 max-w-96" src="https://www.wedium.com/wp-content/uploads/2022/03/best-groom-makeup-in-bhubaneswar.jpg" alt="Photography image" />
    </Link>
    <div class="px-5 pb-5 ">
        <Link to="#">
        ...
        <br />
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">From Rs.20,000</span>
