...
const [isOpen, setIsOpen] = useState(false);
  ...
  const toggleModal = () => {
    ...
    return (
        <div>
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="#">
    ...
    <div class="px-5 pb-5 ">
        ...
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">From Rs.2000</span>
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5 ">
        ...
        <br />
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">From Rs.3500</span>
...
<div class="my-2 flex flex-col lg:flex-row w-full h-max max-w-full  bg-fuchsia-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5 ">
        ...
        <br />
        <div class="flex items-center justify-between" >
            <span class="text-xl text-gray-900 font-light dark:text-white">From Rs.3000</span>
